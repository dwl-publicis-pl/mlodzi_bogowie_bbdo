...
<div class="jumbotron border-top">
    ...
    <a href="mit-emerytura-nie-potrwa-dlugo" class="btn btn-left"<?php echo Tpl::getGTMLinkData('mit-emerytura-nie-potrwa-dlugo', 'kafelki', 'mity'); ?>>
        <img src="img/icon-arrow-left.png" alt="">
        Poprzedni<br>mit
    </a>

    <a href="mit-nie-stac-mnie-na-oszczedzanie" class="btn btn-right"<?php echo Tpl::getGTMLinkData('mit-nie-stac-mnie-na-oszczedzanie', 'kafelki', 'mity'); ?>>
    ...
    <div class="row row-filled-red">
        <div class="col-xs-12">
            <div class="text-center">
                ...
                <a href="https://formularz.prudential.pl/lead?lid=46388" class="btn btn-primary btn-white" target="_blank" data-trigger="run-conversion" data-id="798548">Zaplanuj swoją emeryturę <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>
            </div>
        </div>
    </div>
