        ...
        <div class="col-xs-12 quiz-q quiz-result quiz-result-2 border-top full-height">
            ...
            <div class="row quiz-result-red">
                <div class="col-xs-12 col-md-8 col-md-offset-1 col-lg-5 col-lg-offset-2">
                    ...
                    <div class="cta-button-container">
                        <a href="emerytura-bez-obaw" class="btn btn-link btn-white">Emerytura bez obaw <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a>
                        <a href="ochrona-zdrowia" class="btn btn-link btn-white">Ochrona zdrowia <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a>
                        <a href="przyszlosc-dziecka" class="btn btn-link btn-white">Przyszłość dziecka <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xs-12 quiz-q quiz-result quiz-result-3 border-top full-height">
            ...
            <div class="row quiz-result-red">
                <div class="col-xs-12 col-md-8 col-md-offset-1 col-lg-5 col-lg-offset-2">
                    ...
                    <div class="cta-button-container">
                        <a href="mit-panstwo-da-mi-dobra-emeryture#kalkulator" class="btn btn-link btn-white">Chwila prawdy <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a>
                        <a href="mit-o-emeryturze-moge-pomyslec-pozniej#kalkulator" class="btn btn-link btn-white">Im wcześniej, tym lepiej <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a>
                        <a href="mit-na-emeryturze-moje-potrzeby-beda-mniejsze#kalkulator" class="btn btn-link btn-white">Projekt emerytura <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></a>
                    </div>
                </div>
            </div>
